...
class YOLO(object):
    ...
    def train(self, train_imgs,     # the list of images to train the model
        ...
        checkpoint = ModelCheckpoint(saved_weights_name, 
                                     ...
                                     mode='min', 
                                     period=1)
        tb_counter  = len([log for log in os.listdir('C:/Users/micha/Documents/object_detection/yolo_test/logs/') if 'yolo' in log]) + 1
        tensorboard = TensorBoard(log_dir=os.path.expanduser('C:/Users/micha/Documents/object_detection/yolo_test/logs/') + 'yolo' + '_' + str(tb_counter), 
                                  histogram_freq=0, 
